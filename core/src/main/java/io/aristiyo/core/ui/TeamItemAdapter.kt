...
class TeamItemAdapter(var onItemClicked: (Team) -> Unit) :
    ...
    inner class ItemViewHolder(private var binding: ItemTeamBinding) :
    ...
    companion object {
        private val DIFF_CALLBACK: DiffUtil.ItemCallback<Team> =
            object : DiffUtil.ItemCallback<Team>() {
                override fun areItemsTheSame(p0: Team, p1: Team): Boolean {
                    return p0.idTeam == p1.idTeam
                }

                override fun areContentsTheSame(p0: Team, p1: Team): Boolean {
                    return p0 == p1
                }
            }
    }
